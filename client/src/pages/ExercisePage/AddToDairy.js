    ...
    >
      ...
      {search ? (
          ...
          >
            ...
            >
              ...
              >
                <i>
                  {" "}
                  If you know how many calories you burned (e.g. from a machine
                  at the gym), manually enter that value above
                </i>
              </Text>
        ...
        <HStack fontSize='17px'  fontWeight='bold' justifyContent='center'>
          ...
          <Text color='#00548f' _hover={{color:"orange"}}>Add an exercise to the database</Text>       
           </HStack>
        </Box>
