  ...
  return (
    <Box >
      <Box w={["100%","70%","70%"]} m='auto'>
        <Box m='10px 0'>
          <Text fontSize={['16px','18px','20px']} fontWeight='bold'>Charts and Reports</Text>
        </Box>
        <hr />
        <Box m='10px 0'>
          ...
          <Box>
            <HStack gap='5px'>
            <Text fontSize={['14px','16px','18px']} fontWeight='bold'>Choose a report:</Text>
          ...
          <Box>
          <CSVLink {...csvLink}>
            <Button variant='solid' colorScheme='green' p='2px 30px'>Export</Button>
          </CSVLink>
          </Box>
          </Flex>
        </Box>
        <Box m='10px 0'>
          <Text fontSize={['14px','16px','18px']} fontWeight='bold'>Reporting period:</Text>
