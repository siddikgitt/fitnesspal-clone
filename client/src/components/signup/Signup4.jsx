...
const Signup4 = () => {
  ...
  // const [authvalue, setAuthValue] = useState(init);
          ...
          <Center >
            ...
            >
              ...
              <RadioGroup  name='gender' >
                <Stack direction="row">
                  <Radio onClick={(e)=>setSignup({...signup,gender:"Male"})}  value="Male" >Male</Radio>
                  <Radio value="Female" onClick={(e)=>setSignup({...signup,gender:"Female"})}>Female</Radio>
                </Stack>
              </RadioGroup>
              ...
              onChange={(e)=>setSignup({...signup,dob:e.target.value})}
                name='dob' placeholder="Select Date and Time" type="date" />
