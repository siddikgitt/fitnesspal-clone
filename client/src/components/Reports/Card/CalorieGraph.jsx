...
const CalorieGraph = () => {
  ...
  return (
    ...
    <Box bg='#F6F6F8' borderTopRadius='8px'  p='15px 20px' >
        ...
        <Text fontSize='15px'>Stick with it! You have a fresh chance to hit your calorie goal this upcoming week.</Text>
      </Box>
      <Center>
        <Text fontSize='14px' color='grey'>Weekly Summary</Text>
      </Center>
      <Box w='100%' h='300px'>
