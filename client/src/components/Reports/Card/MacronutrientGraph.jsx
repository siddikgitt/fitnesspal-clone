...
const MacronutrientGraph = () => {
  ...
  return (
    <Box border='1px solid #F6F6F8'  color='black' borderRadius='10px' h='500px' w={["90%","90%","70%"]} m='20px auto' >
    <Box bg='#F6F6F8' borderTopRadius='8px'  p='15px 20px' >
        <Text fontSize='22px'>Macronutrients</Text>
        <Text fontSize='15px'>Our receipe importer calculates the macronutrient breakdown of your favourite recipes.</Text>
    </Box>
    <Box w='100%' h='400px'>
